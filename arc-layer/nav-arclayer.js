...
const { Layer, project32, picking, UNIT } = deck
...
class NavArcLayer extends Layer {
  getShaders() {
...
NavArcLayer.layerName = 'NavArcLayer';
NavArcLayer.defaultProps = defaultProps;
